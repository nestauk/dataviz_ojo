...
>
	...
	>
		...
		<div class='text_content'>
			...
			<p>In order to provide tractable insights on skills, we have clustered the surface forms to form a taxonomy. At the top (or ‘broadest’) level of the taxonomy, there are eight groups of skills, including one group that consists entirely of transversal skills. <a href='https://github.com/nestauk/ojo_daps_mirror/tree/main/ojd_daps/flows/enrich/labs/skills'>The full skills taxonomy is available on Github</a>. We will continue to revise the taxonomy, as part of our work for the <a href='https://www.escoe.ac.uk/'>Economic Statistics Centre of Excellence (ESCoE)</a>.</p>   
		</div>
